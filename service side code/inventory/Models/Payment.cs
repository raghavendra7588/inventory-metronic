...
namespace inventory.Models
{
    ...
    public class PaymentBL
    {
        ...
        public string updatePaymentMode(UpdatePaymentMode updatePaymentModeData)
        {
            ...
            cmd.Parameters.AddWithValue("@UpdatedExpiryDate", updatePaymentModeData.UpdatedExpiryDate);
            cmd.Parameters.AddWithValue("@SubscriptionStartDate", updatePaymentModeData.SubscritpionStartDate);
